...
<!--&lt;!&ndash;                    {{item}}&ndash;&gt;{{item.content}}-->
        ...
        <span @click="uploader" style="position: fixed;bottom: 1rem;display: block;width: 80%;line-height: .7rem;background: #00b5bd;color: white;left: calc(50% - 40%);text-align: center;border-radius: .1rem">上传</span>
    </div>
</template>
